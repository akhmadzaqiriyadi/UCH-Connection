...
export class AuthService {
  ...
  async register(data: RegisterDTO): Promise<AuthResponse> {
    ...
    // Fetch relations if any (likely null for new user unless transactional magic happening elsewhere)
    // But consistent return type is good.
